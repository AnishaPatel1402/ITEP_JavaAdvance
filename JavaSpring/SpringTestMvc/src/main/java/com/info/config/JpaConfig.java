...
@EnableJpaRepositories(basePackages = {"com.info.repo"})
@ComponentScan(basePackages = {"com.info.service"})
@Configuration
...
public class JpaConfig {
	...
	public DriverManagerDataSource getDataSource() {
		...
		dataSource.setUrl("jdbc:mysql://localhost:3306/spring_test_mvc");
